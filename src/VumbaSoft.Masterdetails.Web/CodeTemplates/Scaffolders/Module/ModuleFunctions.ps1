Function Scaffold-CsTemplate([String]$Template, [String]$Project, [String]$OutputPath)
{
    ...
    $ControllerNamespace = "VumbaSoft.Masterdetails.Controllers"
    $ControllerTestsNamespace = "VumbaSoft.Masterdetails.Tests.Unit.Controllers"
    If ($Area) { $ControllerNamespace = "VumbaSoft.Masterdetails.Controllers.$Area" }
    If ($Area) { $ControllerTestsNamespace = "VumbaSoft.Masterdetails.Tests.Unit.Controllers.$Area" }
...
Function Scaffold-AreaRegistration([String]$Template, [String]$Project, [String]$OutputPath)
{
    if (!$Delete)
    {
        $ControllerNamespace = "VumbaSoft.Masterdetails.Controllers.$Area"
        $ControllerTestsNamespace = "VumbaSoft.Masterdetails.Tests.Unit.Controllers.$Area"
