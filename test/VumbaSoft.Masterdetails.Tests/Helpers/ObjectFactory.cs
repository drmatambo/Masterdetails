...
namespace VumbaSoft.Masterdetails.Tests
{
    public static class ObjectFactory
    {
        ...
        public static Country CreateCountry(Int32 id = 0)
        {
            return new Country
            {
            };
        }
        public static CountryView CreateCountryView(Int32 id = 0)
        {
        ...
        public static State CreateState(Int32 id = 0)
        {
            return new State
            {
            };
        }
        public static StateView CreateStateView(Int32 id = 0)
        {
        ...
        public static City CreateCity(Int32 id = 0)
        {
            return new City
            {
            };
        }
        public static CityView CreateCityView(Int32 id = 0)
        {
            return new CityView
            {
                Id = id
