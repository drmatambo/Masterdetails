using VumbaSoft.Masterdetails.Controllers.Administration;
using System;
using System.Web.Mvc;
using System.Web.Routing;
using Xunit;

namespace VumbaSoft.Masterdetails.Tests.Unit.Controllers.Administration
{
    public class AdministrationAreaRegistrationTests
    {
        ...
        public void RegisterArea_MultilingualRoute()
        {
            ...
            Assert.Equal(new[] { "VumbaSoft.Masterdetails.Controllers.Administration" }, actual.DataTokens["Namespaces"] as String[]);
